...
const fullText3 = splitLines("Chúc cậu luôn bình yên, vui vẻ", 7);
const fullText4 = splitLines("Và gặp thật nhiều điều làm cậu thấy thật thoải mái!", 6);
const fullText5 = splitLines("Mong là hôm nay đối xử với cậu tốt 1 chút.", 6);
const fullText6 = splitLines("Thế là đủ cho 1 ngày đẹp rồi.", 7);
const fullText7 = splitLines("À còn nữa nè", 4);
const fullText8 = splitLines("Nếu mà cuộc sống không như ý cậu", 4);
const fullText9 = splitLines("Tôi sẽ theo ý cậu!", 5);
const fullText10 = splitLines("Dù cả thế giới có quay lưng", 4);
const fullText11 = splitLines("Tôi vẫn nguyện sẽ là người..", 4);
const fullText12 = splitLines("Đứng lại bên cậu đến giây phút cuối cùng", 5);
